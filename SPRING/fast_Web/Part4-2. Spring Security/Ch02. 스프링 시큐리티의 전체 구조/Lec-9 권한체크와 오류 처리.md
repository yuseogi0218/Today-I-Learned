...
## 스프링의 인증과 권한
  ...
  ![](../images/fig-18-authentication-authorization.png)

---

## FilterSecurityInterceptor

  ![](../images/fig-20-filtersecurityinterceptor.png)

- SecurityInterceptor : AccessDecisionManager 를 통해 권한여부를 판단하고 통과시켜주거나 Deny 합니다.
- 주요 처리 로직이 아래와 같습니다.
  ![](../images/fig-19-filtersecurityinterceptor-invoke.png)
...
- 그 밖의 오류는 보통 ControllerAdvice 를 이용해서 처리하는 것을 권장합니다.
  ...
  ![](../images/fig-21-exception-translation-filter.png)
