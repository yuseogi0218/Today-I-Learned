...
- **즉, Authentication 객체 내부의 authenticated 속성의 값이 true 이고, Authentication 이 Authentication 이 AnonymousAuthenticationToken 이 아닌 경우**
...
![](../images/fig-3-authentication.png)

- 인증 토큰(Authentication)을 제공하는 필터들

  - UsernamePasswordAuthenticationFilter : 폼 로그인 -> UsernamePasswordAuthenticationToken
  - RememberMeAuthenticationFilter : remember-me 쿠키 로그인 -> RememberMeAuthenticationToken (자동 로그인)
